...
public class CommentAccessHandler {
    private static final Logger logger = LogManager.getLogger(CommentAccessHandler.class);
    private final CommentService commentService;

    @Autowired
    public CommentAccessHandler(CommentService commentService) {
        this.commentService = commentService;
    }

    /**
     * Decides whether the current user can patch the comment with the specified ID.
     *
     * @param id ID of the comment being patched
     *
    ...
    /**
     * Decides whether the current user can delete the comment with the specified ID.
     *
